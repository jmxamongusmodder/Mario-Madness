...
class WarpStateAlt extends MusicBeatState
{
	var tween:FlxTween;
	var tween2:FlxTween;
	...
	override function create()
	{
		...
		bg = new FlxSprite(800, 250).loadGraphic(Paths.image('wwc/warpmap'));
		...
		cartel = new FlxSprite(570, 620).loadGraphic(Paths.image('wwc/textwarp'));
		...
		pibemapa.frames = Paths.getSparrowAtlas('wwc/mariomap');
